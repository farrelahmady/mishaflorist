<div>
    <button wire:click="$set('show', true)"
        class="bg-stone-500 text-white active:bg-stone-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">Add
        Product</button>
